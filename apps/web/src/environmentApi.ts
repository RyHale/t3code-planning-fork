...
export function createEnvironmentApi(rpcClient: WsRpcClient): EnvironmentApi {
  return {
    ...
    projects: {
      ...
      loadAgentBoard: rpcClient.projects.loadAgentBoard,
      saveAgentBoard: rpcClient.projects.saveAgentBoard,
      claimAgentBoardCard: rpcClient.projects.claimAgentBoardCard,
    },
    filesystem: {
