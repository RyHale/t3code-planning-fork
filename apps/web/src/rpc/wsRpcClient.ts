...
export interface WsRpcClient {
  ...
  readonly projects: {
    ...
    readonly loadAgentBoard: RpcUnaryMethod<typeof WS_METHODS.projectsLoadAgentBoard>;
    readonly saveAgentBoard: RpcUnaryMethod<typeof WS_METHODS.projectsSaveAgentBoard>;
    readonly claimAgentBoardCard: RpcUnaryMethod<typeof WS_METHODS.projectsClaimAgentBoardCard>;
  };
  readonly filesystem: {
...
export function createWsRpcClient(transport: WsTransport): WsRpcClient {
  return {
    ...
    projects: {
      ...
      loadAgentBoard: (input) =>
        transport.request((client) => client[WS_METHODS.projectsLoadAgentBoard](input)),
      saveAgentBoard: (input) =>
        transport.request((client) => client[WS_METHODS.projectsSaveAgentBoard](input)),
      claimAgentBoardCard: (input) =>
        transport.request((client) => client[WS_METHODS.projectsClaimAgentBoardCard](input)),
    },
    filesystem: {
